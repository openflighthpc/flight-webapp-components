...
function AuthenticatedRoute(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(Route, rest, function (_ref2) {
    var match = _ref2.match,
        location = _ref2.location,
        more = _objectWithoutProperties(_ref2, ["match", "location"]);

    if (currentUser == null) {
      return match == null ? null : /*#__PURE__*/_react["default"].createElement(Redirect, {
        to: {
          pathname: "/",
          state: {
            from: location
...
var _default = AuthenticatedRoute;
